...
namespace OllamaVision
{
    ...
    public class UIAutomationService
    {
        ...
        private System.Windows.Automation.Condition BuildConditionFromIdentifier(ControlIdentifier identifier)
        {
            ...
            if (conditions.Count == 0) return System.Windows.Automation.Condition.TrueCondition;
